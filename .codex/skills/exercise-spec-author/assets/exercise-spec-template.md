...
- Spec kind:
- Spec intent:
- Learner-facing seed or generation rule:
- Why this spec is worth building:
...
- Feedback tone and examples:

## 7. Variants and Constraints

- Variable space:
- Exercise pack source priority:
- Difficulty levers:
- Invalid or misleading cases to avoid:

## 8. Review Checklist

- [ ] Spec kind is explicit
- [ ] Primary skill unit is explicit
- [ ] Learning mode is explicit or marked `not-applicable`
