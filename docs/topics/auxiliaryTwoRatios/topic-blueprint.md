...
**Version note:** `content_id` is `topic-practice.auxiliary-two-ratios.v1` (content identity, ending `.v1`), and registered Actions are `kind@1`. Neither changes the required Action Runtime v2 product model.
