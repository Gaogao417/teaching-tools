...
function mergeServer(existing: VoiceCorrelationTimeline | undefined, update: ServerTimelineUpdate): VoiceCorrelationTimeline {
  ...
  return {
    ...
    narrationArtifactSource: firstDefined(update.narrationArtifactSource, existing?.narrationArtifactSource),
    memoryCacheLookupMs: firstDefined(update.memoryCacheLookupMs, existing?.memoryCacheLookupMs),
    persistentCacheLookupMs: firstDefined(update.persistentCacheLookupMs, existing?.persistentCacheLookupMs),
    singleFlightWaitMs: firstDefined(update.singleFlightWaitMs, existing?.singleFlightWaitMs),
    providerSynthesisMs: firstDefined(update.providerSynthesisMs, existing?.providerSynthesisMs),
    artifactBytes: firstDefined(update.artifactBytes, existing?.artifactBytes),
