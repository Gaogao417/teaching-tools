import { V14_VISUAL_PRESENTER_PROMPT_VERSION, V13_VISUAL_PRESENTER_PROMPT_VERSION, V12_VISUAL_PRESENTER_PROMPT_VERSION, V11_VISUAL_PRESENTER_PROMPT_VERSION, V10_VISUAL_PRESENTER_PROMPT_VERSION, V9_VISUAL_PRESENTER_PROMPT_VERSION, V8_VISUAL_PRESENTER_PROMPT_VERSION, V7_VISUAL_PRESENTER_PROMPT_VERSION, VISUAL_PRESENTER_PROMPT_VERSION, LEGACY_VISUAL_PRESENTER_PROMPT_VERSION, PREVIOUS_VISUAL_PRESENTER_PROMPT_VERSION, isVisualPresenterPromptVersion } from "./PresenterPrompts";
...
export function structuredPresenterGenerator(port: StructuredModelPort, options: { readonly promptVersion?: string } = {}): PresenterGeneratorPort {
  ...
  if (![LEGACY_PRESENTER_PROMPT_VERSION, PREVIOUS_PRESENTER_PROMPT_VERSION, TOOL_INVOCATION_PRESENTER_PROMPT_VERSION, PRESENTER_PROMPT_VERSION, V14_VISUAL_PRESENTER_PROMPT_VERSION, V13_VISUAL_PRESENTER_PROMPT_VERSION, V12_VISUAL_PRESENTER_PROMPT_VERSION, V11_VISUAL_PRESENTER_PROMPT_VERSION, V10_VISUAL_PRESENTER_PROMPT_VERSION, V9_VISUAL_PRESENTER_PROMPT_VERSION, V8_VISUAL_PRESENTER_PROMPT_VERSION, V7_VISUAL_PRESENTER_PROMPT_VERSION, VISUAL_PRESENTER_PROMPT_VERSION, LEGACY_VISUAL_PRESENTER_PROMPT_VERSION, PREVIOUS_VISUAL_PRESENTER_PROMPT_VERSION].includes(promptVersion)) {
