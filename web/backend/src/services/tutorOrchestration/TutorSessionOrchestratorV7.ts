...
export class TutorSessionOrchestratorV7 {
  ...
  static start(input: OrchestratorV7StartInput): TutorSessionOrchestratorV7 {
    ...
    const navigator = NavigatorSessionV7.start({
      ...
      registryProvider: input.clientInstanceId ? visualRegistryProvider(resolver) : resolver.v7RegistryProvider,
      ...
      ...(input.clientInstanceId ? {presentationExecutionOwner:{client_instance_id:input.clientInstanceId,epoch:1}} : {}),
    });
